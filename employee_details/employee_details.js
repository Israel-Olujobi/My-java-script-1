...
function findEmployeeBySpecialization(specialization){
    ...
    if(foundEmployeeS){
        document.getElementById('employeesDetails').innerHTML=`<p>${foundEmployeeS.id}: ${foundEmployeeS.name}: ${foundEmployeeS.department}-$${foundEmployeeS.salary}-${foundEmployeeS.specialization}</p>`;
    }
    else{
